  ...
  <div class="x_panel">
    <div class="x_title">
      ...
      <ol class="breadcrumb">
        ...
        ?>
        <li class="breadcrumb-item"><a href="?page=w_master_share&id=<?php echo $idfile; ?>">Manage Share Of <?php echo $barcode; ?></a></li>
    ...
    <div class="x_content">
      ...
      action="?page=w_prosestambah_share&id=<?php echo $_GET['id']; ?>">
          ...
          <div class="form-group">
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
              <a class="btn btn-primary" type="button" href="?page=w_master_share&id=<?php echo $idfile; ?>">Cancel</a>
