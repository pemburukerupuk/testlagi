  ...
  <div class="x_panel">
    ...
    <div class="x_content">
      ...
      <div class="btn-group" role="group">
          <a href="?page=w_tambah_file" type="button" class="btn btn-success btn-sm">Tambah File</a>
      </div>
      <hr>
          ...
          <tr>
            ...
            <td>
              <div class="btn-group  btn-group-xs">
                <a class="btn btn-info" type="button" href="?page=w_master_share&id=<?php echo $data['idfile']; ?>">
            ...
            <td>
                <div class="btn-group  btn-group-xs">
                  <a class="btn btn-success" type="button" href="?page=w_detail_file&id=<?php echo $data['idfile']; ?>">
                    <div class="btnTooltip" data-placement="top" title="Detail"> 
                      <i class="fa fa-arrows-alt"></i>
                    </div>
                  </a>
                  <a class="btn btn-warning" type="button" href="?page=w_edit_file&id=<?php echo $data['idfile']; ?>">
                    <div class="btnTooltip" data-placement="top" title="Edit"> 
                      <i class="fa fa-pencil"></i>
                    </div>
                  </a>
                  <a class="btn btn-danger" type="button" href="?page=w_prosesdelete_file&id=<?php echo $data['idfile']; ?>"
